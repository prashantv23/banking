...
- `collector-app/src/main/resources/db/migration/`
- `collector-app/src/main/resources/application.yml`
- `analyzer-app/src/main/resources/application.yml`
- `web-app/src/main/resources/application.yml`
- `gradle.properties`

## External Data Import

- Dataset repository: `https://github.com/ahsan084/Banking-Dataset`
- Metadata endpoint:
  `https://api.github.com/repos/ahsan084/Banking-Dataset/contents/Comprehensive_Banking_Database.csv`
- Database URL:
  `jdbc:h2:file:./collector-app/data/collector_db;AUTO_SERVER=TRUE`
